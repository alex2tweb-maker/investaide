...
async function startServer() {
  ...
  app.get("/api/conseillers", async (req, res) => {
    try {
  ...
  app.get("/api/admin/check-connection", async (req, res) => {
    const results = {
    ...
    try {
      ...
      if (planningRes.ok) {
        ...
        results.planning.error = await planningRes.text();
      }
      ...
      if (conseillerRes.ok) {
        ...
        results.conseiller.error = await conseillerRes.text();
      }
